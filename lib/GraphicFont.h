...
public:
	ImpactFont() {
		dataFileName = "lib/resources/ImpactFont01.txt";
		imageFileName = "lib/resources/ImpactFont01.png";
		init();
	}
};
...
public:
	GaramondFont() {
		dataFileName = "lib/resources/GaramondFont01.txt";
		imageFileName = "lib/resources/GaramondFont01.png";
		init();
	}
};
...
public:
	JokermanFont() {
		dataFileName = "./lib/resources/JokermanFont01.txt";
		imageFileName = "./lib/resources/JokermanFont01.png";
		init();
	}
};
...
public:
	ComicSansFont() {
		dataFileName = ".//lib//resources//ComicSansFont01.txt";
		imageFileName = ".//lib//resources//ComicSansFont01.png";
		// init();
	}
};
...
public:
	TimesNewRomanFont() {
		dataFileName = "./lib/resources/TimesNewRomanFont01.txt";
		imageFileName = "./lib/resources/TimesNewRomanFont01.png";
		init();
	}
};
...
public:
	OldEnglishFont() {
		dataFileName = "./lib/resources/OldEnglishFont01.txt";
		imageFileName = "./lib/resources/OldEnglishFont01.png";
		init();
	}
};
